function fetchLancamentos() {
    const endpoints = [
        "http://localhost:3000/lancamentos?tipo=receita",
        "http://localhost:3000/lancamentos?tipo=despesa"
    ];
...
function showData(type) {
    const endpoint = `http://localhost:3000/lancamentos?tipo=${type}`;
...
function addData(type) {
    ...
    if (validatedData) {
        const endpoint = "http://localhost:3000/lancamentos";
...
function deleteData(id) {
    const endpoint = `http://localhost:3000/lancamentos/${id}`;
